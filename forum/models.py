...
class Pergunta(models.Model): # -> heranca classe model 
    titulo = models.CharField(max_length=200, null=False)
    detalhe = models.TextField(null=False) #se tem null=false, o campo é obrigatorio
    ...
    def __str__(self): #retorna versao texto do objeto
...
class Resposta(models.Model): # tambem herda classe model
    pergunta = models.ForeignKey(Pergunta, on_delete=models.CASCADE) #tem que estar associada a pergunta
